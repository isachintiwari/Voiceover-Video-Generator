...
st.markdown("""
   <div style='text-align: center;'>
       ...
       <a href='https://coff.ee/isachintiwari' target='_blank'>
            <img src='https://cdn.buymeacoffee.com/buttons/v2/default-orange.png' alt='Buy Me A Coffee' style='height: 28px !important;max-width: 50% !important; margin-top: 5px;'>
            <img src='https://cdn.buymeacoffee.com/buttons/v2/default-orange.png' alt='Buy Me A Coffee' style='height: 28px !important; width: 50% !important; margin-top: 5px;'>
       </a>
   </div>
